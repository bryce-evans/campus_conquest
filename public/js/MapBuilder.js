...
MapBuilder.prototype.zoom = function(event) {
...
MapBuilder.prototype.onMouseMove = function(event) {
...
MapBuilder.prototype.panAuto = function(x, y) {
...
MapBuilder.prototype.getHitObject = function() {
  try {
...
MapBuilder.prototype.blend = function(mat1, mat2) {
...
MapBuilder.prototype.contains = function(obj, array) {
...
MapBuilder.prototype.keyControls = function(e) {
  e = window.event || e;
  ...
  MapBuilder.prototype.load = function(model) {
  ...
  MapBuilder.prototype.loadBasic = function(model) {
 ...
 */
MapBuilder.prototype.getConnected(obj) {
  var name = obj["name"];
 ...
 */
MapBuilder.prototype.getBuilding(str) {
  return json["Cornell"]["Territories"][str];
}

MapBuilder.prototype.loadBoard = function() {
