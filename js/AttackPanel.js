...
attackPanel = function(cur_force, full_force, reinforce, enemy) {

    const titleYou = "Duffield";
    const titleThem = "Barton";

    var max_force = full_force + reinforce;
    var reinforcements = reinforce;
    var enemy_force = enemy;
