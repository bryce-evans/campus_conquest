...
(function() {
  ...
  //http://www.opengl.org/registry/doc/GLSLangSpec.Full.1.20.8.pdf (p.11)
  CodeMirror.defineMIME("text/x-glsl", {
    name: "clike",
    keywords: words("attribute const uniform varying " +
                    "centroid " +
                    ...
                    "struct " +
                    "" + // below keywords reserved for the future use
                    "asm " +
                    ...
                    "sizeof cast " +
                    "namespace using "),
    blockKeywords: words("do else for if switch while struct"),
